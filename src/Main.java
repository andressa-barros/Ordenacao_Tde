// Classe principal — executa e compara todos os algoritmos
public class Main {
    public static void main(String[] args) {
        ...
        // Executa todos os algoritmos para cada vetor
        testarTodos("Vetor 1", vetor1);
        testarTodos("Vetor 2", vetor2);
        testarTodos("Vetor 3", vetor3);
    }

    // Função que aplica todos os algoritmos em um mesmo vetor
